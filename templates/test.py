...
mdb.Job(name='Biegen', model='Model-1', description='', type=ANALYSIS, 
...
mdb.save()
#: The model database has been saved to "C:\temp\3Punkt_Biegen.cae".
mdb.jobs['Biegen'].writeInput(consistencyChecking=OFF)
#: The job input file has been written to "Biegen.inp".
mdb.save()
#: The model database has been saved to "C:\temp\3Punkt_Biegen.cae".
mdb.jobs['Biegen'].submit(consistencyChecking=OFF)
